...
## Failų struktūra
* `KMI_modelis.R` - Pagrindinis R skriptas, kuriame realizuotas duomenų apjungimas, Elastic Net modelio treniravimas, Random Forest ansamblio kūrimas ir 10-fold kryžminė patikra.
